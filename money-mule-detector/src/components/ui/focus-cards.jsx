...
export const Card = React.memo(
  ({
    ...
    <motion.div
      ...
      onClick={onClick}
      className={cn(
        "rounded-2xl border border-white/5 relative bg-[#030303] overflow-hidden aspect-[4/3] md:aspect-auto md:h-96 w-full transition-all duration-300 ease-out cursor-pointer group",
