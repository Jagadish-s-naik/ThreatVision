...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        "relative flex w-full flex-col items-center justify-start overflow-hidden bg-[#030303] z-0 pt-[220px] pb-12",
        className
      )}
    >
      <div className="absolute top-[180px] flex w-full scale-y-100 items-center justify-center isolate z-0">
        <motion.div
